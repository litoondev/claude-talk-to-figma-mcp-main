...
//
// NOTE: comment tools (get_my_comments, reply_to_comment, ...) are intentionally
// absent from this union. They do not travel over the WebSocket relay because
// the Figma Plugin API cannot see comments; they call the REST API directly.
// See utils/figma-rest.ts and tools/comment-tools.ts.
